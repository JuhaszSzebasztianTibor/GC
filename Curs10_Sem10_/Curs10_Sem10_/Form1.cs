...
namespace Curs10_Sem10_
{
    ...
    {
        //Triangularea fiecărui poligon monoton obținut prin partiționarea unui poligon
        //simplu în poligoane monotone, folosind algorimul de complexitate liniară prezentat în Cursul 10
        ...
        private void panel1_MouseUp(object sender, MouseEventArgs e)
        {
            ...
            if (drawingMode)
            {
                ...
                contor++;
                g.DrawEllipse(new Pen(Color.Gray, 4), aux.X - 2, aux.Y - 2, 4, 4);
                if (points.Count != 0)
                {
